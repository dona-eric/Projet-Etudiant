...
# laod the model
model_etudiant = joblib.load(
    "/home/dona-erick/Projet-Etudiant/Data_Health_Student/Analyse_health_student/model_etudiant.pkl",
    mmap_mode="r",
)
...
def risque_etudiant(data: dict):
    ...
    try:
        ...
        if prediction == 2:
            return {
                "niveau_risque": "High",
                "message": "Le niveau de risque de l'étudiant est élevé.",
            }
        elif prediction == 1:
            return {
                "niveau_risque": "Medium",
                "message": "Le niveau de risque de l'étudiant est moyen.",
            }
        else:
            return {
                "niveau_risque": "Low",
                "message": "Le niveau de risque de l'étudiant est faible.",
            }
    except Exception as e:
